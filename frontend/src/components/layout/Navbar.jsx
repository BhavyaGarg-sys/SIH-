        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <button 
              ...
              className="flex items-center gap-1.5 bg-brand-600 hover:bg-brand-700 text-white text-xs font-bold px-4 py-2 rounded-lg shadow-sm shadow-brand-500/30 hover:shadow-brand-500/50 transition active:scale-95"
            >
